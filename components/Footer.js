...
const Footer = ({ dark, links }) => {
  return (
    <div className={dark ? styles.footercontainerdark : styles.footercontainerlight}>
      <div className={styles.links}>
        <div className={styles.socialscontainer}>
          <a
            ...
            href="https://github.com/waseemkhanyes"
          >
            <FiGithub size={20} />
          </a>
          <a
            ...
            target="_blank"
            className={styles.link}
            href="https://www.linkedin.com/in/waseem-khan-123456789/"
          >
            <FiLinkedin size={20} />
          </a>
          <a
            ...
            target="_blank"
            className={styles.link}
            href="mailto:waseemkhaandev@gmail.com"
          >
            <FiMail size={20} />
          </a>
        </div>
      ...
      <p className={styles.text}>Created By Waseem Khan 2026</p>
    </div>
  );
};
